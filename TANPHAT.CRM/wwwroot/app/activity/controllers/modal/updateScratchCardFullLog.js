(function () {
    app.controller('Activity.updateScratchCardFullLog', ['$scope', '$rootScope', '$state', 'viewModel', '$uibModalInstance', 'shiftStatus', 'userService', 'notificationService',
            ...
            vm.save = function () {
                if (vm.RevisionNumberUpdate != vm.TotalReceive && vm.RevisionNumberUpdate != null && !vm.isSaving) {
                    ...
                    var data = {
                        ...
                        ScratchcardFullLogId: vm.Id,
                        RevisionNumber: Number(vm.RevisionNumberUpdate)
                    }
                    console.log("data: ", data)

                    /*data = JSON.stringify(data);*/
                    userService.updateScratchcardFullLog(data).then(function (res) {
                        if (res && res.Id > 0) {
                            setTimeout(function () {
