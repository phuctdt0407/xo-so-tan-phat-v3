(function () {
    app.controller('User.schedule', ['$scope', '$rootScope', '$state', 'viewModel', 'sortIcon', 'authService', '$uibModal', 'shiftStatus',
        function ($scope, $rootScope, $state, viewModel, sortIcon, authService, $uibModal, shiftStatus) {
                    ...
                    vm.listDistribute.forEach(function (item) {
                        ...
                        if (name) {
                            var temp = {
                                ...
                                "title": (name ? name.Name : 'Nhân viên không tồn tại') + (status ? status.SName : ''),
                                "shift": item.ShiftId,
                                "userId": item.UserId,
                                "name": name ? name.Name : 'Nhân viên không tồn tại' + (status ? status.SName : ''),
            ...
            $(document).ready(function () {
                setTimeout(function () {
                    ...
                    $(".fc-col-header-cell-cushion").css("padding", "0")
                    $(".fc-col-header-cell-cushion").css("font-size", "14px")
            ...
            console.log("listEvent: ", vm.listEvent)
