(function () {
    app.controller('User.checkSchedule', ['$scope', '$rootScope', '$state', 'viewModel', 'notificationService', 'userService', 'dayOfWeekVN', 'shiftStatus', '$uibModal', 
        function ($scope, $rootScope, $state, viewModel, notificationService, userService, dayOfWeekVN, shiftStatus, $uibModal) {
            ...
            //End...algorithm
            vm.openPopup = function (shift, model = {}, list = {},isApplyAll= false) {
            ...
            vm.initData = function () {
                ...
                console.log(" vm.listDateOff ", vm.listDateOff);
                ...
                console.log(" vm.listDateOff1 ", vm.listDateOff);
            ...
            vm.save = function () {
                ...
                if (vm.totalDup == 0 || currentEvi != 'pro') {
                    ...
                    if (vm.listSave.length == 0) {
                        ...
                        userService.distributeShiftMonth(vm.distributeInfo).then(function (res) {
                            if (res && res.Id > 0) {
