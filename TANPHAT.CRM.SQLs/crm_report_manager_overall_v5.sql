-- ================================
-- Author: Vinh
-- Description: Lấy report tổng cho trưởng nhóm (ko lấy data vé số)
-- Created date: 19/04/2023
-- SELECT * FROM crm_report_manager_overall_v5(12,'2023-04-19',1);
-- ================================
SELECT dropallfunction_byname('crm_report_manager_overall_v5');
CREATE OR REPLACE FUNCTION crm_report_manager_overall_v5
(
	p_user_role_id INT,
