...
-- Description:
-- Created date:
-- SELECT * FROM crm_get_salary_divide_for_salepoint_v1('2023-03');
-- ================================
SELECT dropallfunction_byname('crm_get_salary_divide_for_salepoint_v1');
CREATE OR REPLACE FUNCTION crm_get_salary_divide_for_salepoint_v1
(
	p_month VARCHAR
)
RETURNS TABLE
