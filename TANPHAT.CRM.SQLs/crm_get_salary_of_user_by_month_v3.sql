...
-- Description:
-- Created date:
-- SELECT * FROM crm_get_salary_of_user_by_month_v3('2022-07',3);
-- ================================
SELECT dropallfunction_byname('crm_get_salary_of_user_by_month_v3');
CREATE OR REPLACE FUNCTION crm_get_salary_of_user_by_month_v3
(
	p_month VARCHAR,
	p_user_id INT
)
