...
-- Description:
-- Created date:
-- SELECT * FROM crm_get_pre_shift_distribute_id_transfer_remaining(212, 16);
-- ================================
SELECT dropallfunction_byname('crm_get_pre_shift_distribute_id_transfer_remaining');
CREATE OR REPLACE FUNCTION crm_get_pre_shift_distribute_id_transfer_remaining
(
	p_shift_dis_id INT,
	p_channel_id INT
)
