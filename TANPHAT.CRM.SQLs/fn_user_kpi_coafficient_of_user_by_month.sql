...
-- Description:
-- Created date:
-- SELECT * FROM fn_user_kpi_coafficient_of_user_by_month('2023-01', 3);
-- ================================
SELECT dropallfunction_byname('fn_user_kpi_coafficient_of_user_by_month');
CREATE OR REPLACE FUNCTION fn_user_kpi_coafficient_of_user_by_month
(
	p_month VARCHAR,
	p_user_id INT 
)
