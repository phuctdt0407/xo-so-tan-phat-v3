...
-- Description:
-- Created date:
-- SELECT * FROM crm_salepoint_create_or_update_guest(0, 'System', 1, '{"GuestId": 6, "FullName": "Trần Minh Tiến Lê Béo", "Phone": "84938226183","SalePointId": 2, "IsWholesale": "TRUE", "WholesalePriceId": 2, "ScratchPriceId": 1 }')
-- ================================
SELECT dropallfunction_byname('crm_salepoint_create_or_update_guest');
CREATE OR REPLACE FUNCTION crm_salepoint_create_or_update_guest
(
	p_action_by INT,
