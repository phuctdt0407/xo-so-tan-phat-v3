...
-- Description:
-- Created date:
-- SELECT * FROM crm_get_salary_of_user_by_month_v6('2023-04',0);
-- ================================
SELECT dropallfunction_byname('crm_get_salary_of_user_by_month_v7');
CREATE OR REPLACE FUNCTION crm_get_salary_of_user_by_month_v7
(
	p_month VARCHAR,
	p_user_id INT
)
