...
-- Description:
-- Created date:
-- SELECT * FROM crm_salepoint_get_commision_of_all_user_in_month_v2('2023-01');
-- ================================
SELECT dropallfunction_byname('crm_salepoint_get_commision_of_all_user_in_month_v2');
CREATE OR REPLACE FUNCTION crm_salepoint_get_commision_of_all_user_in_month_v2
(
	p_month VARCHAR
)
RETURNS TABLE
