...
-- Description:
-- Created date:
-- SELECT * FROM crm_report_data_finish_shift_v5_reuse_lottery_money(87, 14032);
-- ================================
SELECT dropallfunction_byname('crm_report_data_finish_shift_v5_reuse_lottery_money');
CREATE OR REPLACE FUNCTION crm_report_data_finish_shift_v5_reuse_lottery_money
(
	p_user_role INT,
	p_shift_dis_id INT,
