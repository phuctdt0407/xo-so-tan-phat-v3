...
-- SELECT * FROM crm_user_create_v2(0, 'system', '[{"Account":"Viet 123test ngày 16 tháng 12 2022","FullName":"Việt Đập Đá","Phone":"123123123","Email":"conch1imnon@gmail.com", "NumberIdentity":"06348132","BankAccount":"10202","Address":"189 đường con chó","SalePointId": 1}]');
-- ================================
SELECT dropallfunction_byname('crm_user_create_v2');
CREATE OR REPLACE FUNCTION crm_user_create_v2
(
	p_action_by INT,
