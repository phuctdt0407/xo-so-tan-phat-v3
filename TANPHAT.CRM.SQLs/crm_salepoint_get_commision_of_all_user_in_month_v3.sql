...
-- Description:
-- Created date:
-- SELECT * FROM crm_salepoint_get_commision_of_all_user_in_month_v3('2023-04');
-- ================================
SELECT dropallfunction_byname('crm_salepoint_get_commision_of_all_user_in_month_v3');
CREATE OR REPLACE FUNCTION crm_salepoint_get_commision_of_all_user_in_month_v3
(
	p_month VARCHAR
)
RETURNS TABLE
