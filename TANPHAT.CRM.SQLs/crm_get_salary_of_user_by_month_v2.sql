...
-- Description:
-- Created date:
-- SELECT * FROM crm_get_salary_of_user_by_month_v2('2022-07');
-- ================================
SELECT dropallfunction_byname('crm_get_salary_of_user_by_month_v2');
CREATE OR REPLACE FUNCTION crm_get_salary_of_user_by_month_v2
(
	p_month VARCHAR
)
RETURNS TABLE
