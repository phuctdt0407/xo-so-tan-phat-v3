...
-- SELECT * FROM crm_salepoint_update_item_v2(1, 'Vinh', 1, '[{"ItemId":13,"Quantity":80,"SalePointId":1,"Month":"2023-08"}]')
-- ================================
SELECT dropallfunction_byname('crm_salepoint_update_item_v2'); 
CREATE OR REPLACE FUNCTION crm_salepoint_update_item_v2
(
	p_action_by INT,
