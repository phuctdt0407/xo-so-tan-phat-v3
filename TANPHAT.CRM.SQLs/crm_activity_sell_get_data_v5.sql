...
-- SELECT * FROM crm_activity_sell_get_data_v5(1448,4,'2023-03-02');
-- ================================
SELECT dropallfunction_byname('crm_activity_sell_get_data_v5');
CREATE OR REPLACE FUNCTION crm_activity_sell_get_data_v5
(
