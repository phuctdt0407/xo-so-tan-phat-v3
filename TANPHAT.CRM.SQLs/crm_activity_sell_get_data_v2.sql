...
-- SELECT * FROM crm_activity_sell_get_data_v2(72,5,'2022-04-05');
-- ================================
SELECT dropallfunction_byname('crm_activity_sell_get_data_v2');
CREATE OR REPLACE FUNCTION crm_activity_sell_get_data_v2
(
