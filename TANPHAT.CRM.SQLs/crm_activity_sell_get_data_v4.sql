...
-- SELECT * FROM crm_activity_sell_get_data_v4(1060,3,'2023-02-03');
-- ================================
SELECT dropallfunction_byname('crm_activity_sell_get_data_v4');
CREATE OR REPLACE FUNCTION crm_activity_sell_get_data_v4
(
