...
-- Description:
-- Created date:
-- SELECT * FROM crm_activity_get_list_lottery_price_sub_agency(NULL);
-- ================================
SELECT dropallfunction_byname('crm_activity_get_list_lottery_price_sub_agency');
CREATE OR REPLACE FUNCTION crm_activity_get_list_lottery_price_sub_agency
(
