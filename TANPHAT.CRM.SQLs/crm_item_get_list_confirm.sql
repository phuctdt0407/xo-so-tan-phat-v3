...
-- SELECT * FROM crm_item_get_list_confirm('2022-07', NULL,1);
-- ================================
SELECT dropallfunction_byname('crm_item_get_list_confirm');
CREATE OR REPLACE FUNCTION crm_item_get_list_confirm
(
	p_month VARCHAR,
