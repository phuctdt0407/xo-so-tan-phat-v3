...
-- SELECT * FROM crm_salepoint_update_cornfirm_item(0, 'System_27_06_2022', 1, '[{"ItemId": 2, "SalePointId": 0, "Quantity": 5}]',26,2,1)
-- SELECT * FROM crm_salepoint_update_cornfirm_item(0, 'System_27_06_2022', 1, '[{"GuestId": 7, "SalePointId": 2,"TotalPrice":120000, "FormPaymentId":1}]',3,3,2)

-- SELECT * FROM crm_salepoint_update_cornfirm_item(0, 'System_29_06_2022', 1, NULL,7,2,3)
-- SELECT * FROM crm_salepoint_update_cornfirm_item(0, 'QUANG CONFIRM', 1, NULL,56,2,4)
--CREATE 
-- Cần trường p_confirm_log_id NULL 
-- SELECT * FROM crm_salepoint_update_cornfirm_item(0, 'System_DEV', 1, '[{"ItemId": 2, "SalePointId": 0, "Quantity": 10}]',NULL,NULL,1)
-- SELECT * FROM crm_salepoint_update_cornfirm_item(0, 'System_DEV', 1, '[{"GuestId": 7, "SalePointId": 2,"TotalPrice":9999, "FormPaymentId":1}]',NULL,NULL,2)

-- SELECT * FROM crm_salepoint_update_cornfirm_item(0, 'System_DEV', 1, '[{"LotteryDate": null, "IsScratchcard": true, "LotteryChannelId": 1000,  "Quantity": -9999,  "LotteryTypeId": 3, "LotteryPriceId": 1}]',NULL,NULL,3, '{"UserRoleId":2,"GuestId":-1,"ShiftDistributeId":430}' )

-- SELECT * FROM crm_salepoint_update_cornfirm_item(0, 'System_DEV', 1, '[{"LotteryDate": null, "IsScratchcard": true, "LotteryChannelId": 1000,  "Quantity": 10,  "LotteryTypeId": 3, "LotteryPriceId": 1}]',NULL,NULL,4, '{"UserRoleId":2,"ShiftDistributeId":430, "Phone": "0938760137", "FullName": "Trần Đức Bo", "SalePointId": 1}' )

-- ================================
SELECT dropallfunction_byname('crm_salepoint_update_cornfirm_item');
CREATE OR REPLACE FUNCTION crm_salepoint_update_cornfirm_item
(
	p_action_by INT,
