...
-- SELECT * FROM crm_activity_confirm_transition_v3(8, 'Hello', '[{"TransitionId":71,"LotteryDate":"2023-01-12","LotteryChannelId":17,"TotalTrans":20,"ConfirmTrans":null,"TotalTransDup":0,"ConfirmTransDup":null,"IsScratchcard":false,"$$hashKey":"object:185"},{"TransitionId":72,"LotteryDate":"2023-01-12","LotteryChannelId":32,"TotalTrans":30,"ConfirmTrans":null,"TotalTransDup":0,"ConfirmTransDup":null,"IsScratchcard":false,"$$hashKey":"object:186"},{"TransitionId":73,"LotteryDate":"2023-01-12","LotteryChannelId":33,"TotalTrans":30,"ConfirmTrans":null,"TotalTransDup":0,"ConfirmTransDup":null,"IsScratchcard":false,"$$hashKey":"object:187"},{"TransitionId":74,"LotteryDate":"2023-01-12","LotteryChannelId":34,"TotalTrans":30,"ConfirmTrans":null,"TotalTransDup":0,"ConfirmTransDup":null,"IsScratchcard":false,"$$hashKey":"object:188"}]',true,2,1)
-- ================================
SELECT dropallfunction_byname('crm_activity_confirm_transition_v3');
CREATE OR REPLACE FUNCTION crm_activity_confirm_transition_v3
(
	p_user_role_id INT,
	p_note VARCHAR,
	p_list_item TEXT,
