...
-- Description:
-- Created date:
-- SELECT * FROM crm_report_sale_of_salepoint_in_month_v3('2023-02');
-- ================================
SELECT dropallfunction_byname('crm_report_sale_of_salepoint_in_month_v3');
CREATE OR REPLACE FUNCTION crm_report_sale_of_salepoint_in_month_v3
(
	p_month VARCHAR
)
RETURNS TABLE
