...
-- SELECT * FROM crm_activity_sell_lottery_v3();
-- ================================
SELECT dropallfunction_byname('crm_activity_sell_lottery_v3');
CREATE OR REPLACE FUNCTION crm_activity_sell_lottery_v3
(
	p_shift_dis_id INT,
	p_user_role_id INT,
	p_action_by INT,
