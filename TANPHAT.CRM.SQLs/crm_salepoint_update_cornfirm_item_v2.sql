...
-- SELECT * FROM crm_salepoint_update_cornfirm_item_v2(1,'Vinh',2,'[{"ItemId":13,"Quantity":2313,"SalePointId":0,"Month":"2022-08"}]',42,1)
-- ================================
SELECT dropallfunction_byname('crm_salepoint_update_cornfirm_item_v2');
CREATE OR REPLACE FUNCTION crm_salepoint_update_cornfirm_item_v2
(
	p_action_by INT,
