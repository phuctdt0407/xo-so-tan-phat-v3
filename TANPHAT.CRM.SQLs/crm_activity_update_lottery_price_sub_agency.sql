-- ================================
-- Author: Quang (Việt sửa ngày 03/13/2023)
...
-- Created date:
-- SELECT * FROM crm_activity_update_lottery_price_sub_agency(3, 'Vinh Pham (Super Admin)',2, '[{"LotteryPriceAgencyId":1, "AgencyId":9,"LotteryChannelId":29,"Price":"11"},{"LotteryPriceAgencyId":12,"AgencyId":9,"LotteryChannelId":29,"Price":"11"}]')
-- ================================
SELECT dropallfunction_byname('crm_activity_update_lottery_price_sub_agency');
CREATE OR REPLACE FUNCTION crm_activity_update_lottery_price_sub_agency
(
	p_action_by INT,
