...
-- Description:
-- Created date:
-- SELECT * FROM crm_report_data_finish_shift_v4(30, 12577, '2023-02-22');
-- ================================
SELECT dropallfunction_byname('crm_report_data_finish_shift_v4');
CREATE OR REPLACE FUNCTION crm_report_data_finish_shift_v4
(
	p_user_role INT,
	p_shift_dis_id INT,
