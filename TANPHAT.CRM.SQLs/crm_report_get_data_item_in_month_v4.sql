...
-- SELECT * FROM crm_report_get_data_item_in_month_v4('2023-02');
-- ================================
SELECT dropallfunction_byname('crm_report_get_data_item_in_month_v4');
CREATE OR REPLACE FUNCTION crm_report_get_data_item_in_month_v4
(
	p_month VARCHAR
)
RETURNS TABLE
